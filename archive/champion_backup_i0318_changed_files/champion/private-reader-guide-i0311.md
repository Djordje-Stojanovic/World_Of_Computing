...
- PDF pointer: `champion/final-private-pdf-pointer-i0318.md`
...
I-0314 update: the current rescue proof has zero visible URL/source-note/caveat mechanics hits in extracted PDF text. It still needs I-0319 through I-0322 for page density, contextual visuals, one-image pages, quantitative enrichment, hostile QA, and final build.

I-0315 update: the current rescue proof begins with the Transformer/attention chapter and moves ChatGPT to chapters 06-07. It still needs I-0319 through I-0322 for page density, contextual visuals, one-image pages, quantitative enrichment, hostile QA, and final build.

I-0316 update: the current rescue proof adds visible date spans, chapter timeline strips, and May 24, 2026 cutoff guards to all 24 chapters. It still needs I-0319 through I-0322 for page density, contextual visuals, one-image pages, quantitative enrichment, hostile QA, and final build.
