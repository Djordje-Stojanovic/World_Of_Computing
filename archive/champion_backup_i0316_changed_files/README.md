...
Updated **2026-05-27** after pass `I-0316`.

- **Latest recorded pass:** `I-0316`, timeline/date-rail and cutoff-control pass.
- **Words:** 103,526 assembled source words across the canonical 24-chapter draft.
- **Chapters:** 24 / 24 main chapters.
- **Current baseline PDF, not final:** `rendered/final_private_i0316/Next-Token-final-private-timeline-date-rails-i0316.pdf`.
- **Final champion pointer:** `champion/final-private-pdf-pointer-i0316.md`.
...
- **Claim status:** `claims.tsv` has 332 supported rows and 0 needs-verification rows after the I-0316 timeline/date-rail pass.
