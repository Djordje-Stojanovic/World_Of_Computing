...
Updated **2026-05-27** after pass `I-0317`.

- **Latest recorded pass:** `I-0317`, page-density and blank-page repair.
- **Words:** 103,526 assembled source words across the canonical 24-chapter draft.
- **Chapters:** 24 / 24 main chapters.
- **Current baseline PDF, not final:** `rendered/final_private_i0317/Next-Token-final-private-page-density-i0317.pdf`.
- **Final champion pointer:** `champion/final-private-pdf-pointer-i0317.md`.
...
- **Claim status:** `claims.tsv` has 333 supported rows and 0 needs-verification rows after the I-0317 page-density repair.
