...
Updated **2026-05-27** after pass `I-0320`.

- **Latest recorded pass:** `I-0320`, quantitative enrichment.
- **Words:** 103,526 assembled source words across the canonical 24-chapter draft.
- **Chapters:** 24 / 24 main chapters.
- **Current baseline PDF, not final:** `rendered/final_private_i0318/Next-Token-final-private-contextual-visuals-i0318.pdf`.
- **Final champion pointer:** `champion/final-private-pdf-pointer-i0320.md`.
...
- **Claim status:** `claims.tsv` has 336 supported rows and 0 needs-verification rows after the I-0320 quantitative enrichment pass.
