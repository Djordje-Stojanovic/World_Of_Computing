...
Updated **2026-05-27** after pass `I-0319`.

- **Latest recorded pass:** `I-0319`, one-visual-per-page layout.
...
- **Final champion pointer:** `champion/final-private-pdf-pointer-i0319.md`.
...
- **Claim status:** `claims.tsv` has 335 supported rows and 0 needs-verification rows after the I-0319 one-visual-page pass.
