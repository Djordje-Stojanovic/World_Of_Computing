...
- Mistral was intentionally unpriced in I-0026 because SNAP-20260524-006 (`S-0063`) is model documentation, not pricing evidence. I-0031 adds an official pricing pair in SNAP-20260525-011/S-0081 and SNAP-20260525-012/S-0082, with normalized rows in `data/mistral_pricing_rows_i0031.tsv`.
...
I-0031 narrows C-0046 by removing the missing-Mistral-pricing-source blocker. C-0046 remains active because Mistral pricing was captured one day after cutoff and because final charts still need model cutoff-status checks plus same-scope rank joins.
