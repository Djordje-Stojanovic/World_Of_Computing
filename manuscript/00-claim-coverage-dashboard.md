...
- Source rows: 80.
- Primary or local-primary source rows: 80.
- Captured snapshot rows: 11.
- Snapshot gap rows: 7.
- Visual asset rows: 12.
- Main chapter count: 24.
- Pending idea rows after pass I-0029: 5.
