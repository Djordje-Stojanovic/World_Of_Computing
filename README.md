...
Updated **2026-05-26** after pass `I-0272`.

- **Latest recorded pass:** `I-0272`, apparatus compression.
- **Latest exhibit dashboard pass:** `I-0236`, fail-closed visual readiness recomputation.
- **Words:** 101,678 assembled source words across the canonical 24-chapter draft after the I-0272 compression pass.
- **Chapters:** 24 / 24.
- **Charts/diagrams:** 142.
- **Photo/screenshot/source-surface slots:** 78.
- **Sources:** 299.
- **Claims:** 288 supported / 0 needs-verification.
...
- **Current model-card/benchmark layer:** I-0286 acquires 9 model-card/HF/repo/docs/leaderboard surfaces and 5 early-era benchmark/model-landscape tables covering 2018,2019,2020,2021,2022 in `data/model_card_benchmark_acquisition_i0286.tsv` and `data/benchmark_model_landscape_tables_i0286.tsv`; screenshots/HTML stay local/ignored and exact score/rank claims remain blocked until row-normalized.
- **Current model-card/benchmark layer:** I-0286 acquires 11 model-card/HF/repo/docs/leaderboard surfaces and 5 early-era benchmark/model-landscape tables covering 2018,2019,2020,2021,2022 in `data/model_card_benchmark_acquisition_i0286.tsv` and `data/benchmark_model_landscape_tables_i0286.tsv`; screenshots/HTML stay local/ignored and exact score/rank claims remain blocked until row-normalized.
- **Completed paper/PDF source-surface layer:** I-0288 brings tracked totals to 25 paper/arXiv/report excerpt exhibits and 25 PDF/deck/presentation/technical-report exhibits across `data/source_surface_pdf_acquisition_i0285.tsv` and `data/source_surface_pdf_completion_i0288.tsv`; PDFs/page rasters remain local/ignored and final placement/quote/rights review remains pending.
- **Current paper/PDF source-surface layer:** I-0285 acquires 0 paper/report page surfaces and 12 PDF/presentation/report/annual-report page surfaces with local PDFs, page renders, lightweight cards, hashes, story-purpose fields, private-use notes, and blocked-claim text in `data/source_surface_pdf_acquisition_i0285.tsv`; PDFs/rasters remain local/ignored and final layout/rights review remains pending.
- **Current paper/PDF source-surface layer:** I-0285 acquires 15 paper/report page surfaces and 15 PDF/presentation/report/annual-report page surfaces with local PDFs, page renders, lightweight cards, hashes, story-purpose fields, private-use notes, and blocked-claim text in `data/source_surface_pdf_acquisition_i0285.tsv`; PDFs/rasters remain local/ignored and final layout/rights review remains pending.
- **Current paper/PDF source-surface layer:** I-0285 acquires 15 paper/report page surfaces and 16 PDF/presentation/report/annual-report page surfaces with local PDFs, page renders, lightweight cards, hashes, story-purpose fields, private-use notes, and blocked-claim text in `data/source_surface_pdf_acquisition_i0285.tsv`; PDFs/rasters remain local/ignored and final layout/rights review remains pending.
- **Current real-world image completion layer:** I-0287 adds 25 source screenshots, 25 logos, and 15 people/profile screenshots; together with I-0284 the ledger now clears 50 source images/screenshots, 50 logos, and 30 people/profile images, all with hashes, provenance, private-use notes, and blocked-claim fields.
- **Current real-world image layer:** I-0284 acquires 25 source images, 25 logos, and 4 person/public-profile images with local files, hashes, story-purpose fields, private-use notes, and blocked-claim text in `data/real_world_image_acquisition_i0284.tsv`; rasters remain local/ignored and final layout/rights review remains pending.
- **Current real-world image layer:** I-0284 acquires 25 source images, 25 logos, and 15 person/public-profile images with local files, hashes, story-purpose fields, private-use notes, and blocked-claim text in `data/real_world_image_acquisition_i0284.tsv`; rasters remain local/ignored and final layout/rights review remains pending.
...
- **Current acquisition toolchain:** I-0281 installs local Python/Node acquisition dependencies and verifies Chrome plus Playwright screenshot capture, PyMuPDF PDF page rendering from `GTC-2026-Keynote.pdf`, Pillow/OpenCV image prep, OCR-assisted extraction, HTML text clipping, SHA-256 provenance logging, and asset-folder conventions in `data/acquisition_toolchain_probe_i0281.tsv`; system CLI gaps remain fallback warnings before bulk visual acquisition.
- **Current visual PDF:** `rendered/full_book_i0280/Next-Token-full-draft-i0280.pdf` exists locally and is intentionally not committed. It embeds 100/100 selected figure callouts as PNG-backed figures, preserves image-object proof, improves caption/source-note typography and provenance ordering, and records 8 pass / 2 warn page-layout QA rows; final caption-size, legal, and production QA remain pending.
...
- **Current page-image QA:** `data/page_image_layout_i0280.tsv` audits 100 figure pages from the I-0280 local visual PDF; 0 figures pass, 100 warn, 0 fail, with 0 P0 defects and extracted caption/source-note minimum font 6.20 pt.
...
- **Current compression pass:** I-0272 removes remaining source-boundary apparatus and editorial/audit-work notes from the reader-facing draft, preserving 24 chapters, the existing full-draft figure callout set, source references, and a safe buffer above the 100,000-word floor.
